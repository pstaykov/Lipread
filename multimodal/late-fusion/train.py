"""
Late fusion: frozen GLipsNet (visual) + frozen Whisper encoder (audio) -> MetaLearner
"""
...
if __name__ == '__main__':
    ...
    train_dataset = GLipsAVDataset(root_dir, split='train',
                                   transform=VideoAugment(crop_size=88, resize_size=96, is_train=True))
    val_dataset = GLipsAVDataset(root_dir, split='validation',
    ...
    meta = MetaLearner(num_classes=500).to(device)
